...
public interface IProductService
{
    ...
    Task<ApiStandardResponse<ProductListingResponse>> GetAllProductAsync(long cursorValue = 0,
        int pageSize = 10);
    ...
    Task<ApiStandardResponse<ProductListingResponse>> GetProductsByCategoryAsync(
        long categoryId,
        long cursorValue = 0,
        int pageSize = 10
    );
